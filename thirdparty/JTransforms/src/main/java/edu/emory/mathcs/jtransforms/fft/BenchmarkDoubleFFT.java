...
public class BenchmarkDoubleFFT {
	...
	public static void benchmarkRealForward_2D_input_2D() {
		...
		IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleRealForwardFFT_2D_input_2D.txt", nthread, niter, doWarmup,
				doScaling, sizes2D, times);
	}
	...
	public static void benchmarkRealForward_3D_input_1D() {
		...
		IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleRealForwardFFT_3D_input_1D.txt", nthread, niter, doWarmup,
	...
	public static void benchmarkRealForward_3D_input_3D() {
		...
		IOUtils.writeFFTBenchmarkResultsToFile("benchmarkDoubleRealForwardFFT_3D_input_3D.txt", nthread, niter, doWarmup,
				doScaling, sizes3D, times);
	}
