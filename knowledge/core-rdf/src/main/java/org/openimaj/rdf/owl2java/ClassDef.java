...
//		}
			...
			final boolean generateAnnotations )
	{
		...
		else
		{
			...
			String xxx = null;
			while( i.hasNext() ) if( !(xxx=i.next()).equals("this") ) 
	 ...
	 * 	tree.
	 * 
	 *	@param pd The set of property definitions (linked to instance name) to fill
	 *	@param instanceNameMap The list of property to instance name map
	 *	@param classes The definition of all the classes in the ontology
	 */
