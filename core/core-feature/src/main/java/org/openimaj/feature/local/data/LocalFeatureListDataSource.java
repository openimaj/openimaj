 ...
 * {@link LocalFeature}s. This can be used as a convenience when you want to
 * feed multiple lists of local features to a clustering algorithm.
 * 
 ...
 */
public class LocalFeatureListDataSource<T extends LocalFeature<?, F>, F extends FeatureVector>
		extends
