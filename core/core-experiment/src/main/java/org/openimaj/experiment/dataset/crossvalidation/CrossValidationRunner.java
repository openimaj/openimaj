...
import org.openimaj.experiment.evaluation.AnalysisResultAggregator;
...
public class CrossValidationRunner {
	...
	public <DATASET extends Dataset<?>,
		...
		run(
				final AnalysisResultAggregator<ANALYSIS_RESULT, AGGREGATE_ANALYSIS_RESULT> aggregator, 
				final Iterable<CrossValidationData<DATASET>> cvIterable, 
				final Round<DATASET, ANALYSIS_RESULT> round) 
	{
		Parallel.ForEach(cvIterable,
