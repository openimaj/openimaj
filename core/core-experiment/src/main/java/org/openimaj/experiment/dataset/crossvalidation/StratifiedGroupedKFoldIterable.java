 ...
 */
public class StratifiedGroupedKFoldIterable<KEY, INSTANCE extends Identifiable> implements Iterable<CrossValidationData<GroupedDataset<KEY, ListDataset<INSTANCE>, INSTANCE>>> {
