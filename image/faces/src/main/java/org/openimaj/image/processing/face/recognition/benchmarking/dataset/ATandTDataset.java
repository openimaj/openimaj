...
public class ATandTDataset extends MapBackedDataset<Integer, ListDataset<FImage>, FImage> {
	/**
	 * Construct the dataset. The dataset must be in a directory called "att_faces"
	 * within a directory called "Data" within your home directory (the "user.home" system 
	 * property).
	 * 
	 ...
	 * @param baseDir the dataset path
	 * 
	 * @throws IOException if an error occurs.
	 */
