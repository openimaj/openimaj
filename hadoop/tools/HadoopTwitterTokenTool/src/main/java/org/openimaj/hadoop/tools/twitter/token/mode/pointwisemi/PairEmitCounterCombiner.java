 ...
 *
 */
public class PairEmitCounterCombiner extends Reducer<LongWritable, BytesWritable, LongWritable, BytesWritable> {
	@Override
	protected void reduce(LongWritable pair, Iterable<BytesWritable> paircounts, Reducer<LongWritable,BytesWritable,LongWritable,BytesWritable>.Context context) throws IOException ,InterruptedException {
