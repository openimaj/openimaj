...
/**
 * A download bolt instantiates {@link StatusConsumer} on {@link Status}
 * recieved
 * 
...
public class DownloadBolt implements IRichBolt {
	...
	public void execute(Tuple input) {
		final ReadableWritableJSON json = (ReadableWritableJSON) input.getValue(0);
		final StatusConsumer consumer = new StatusConsumer(stats, globalStats, outputLocation, outmodes);
		try {
