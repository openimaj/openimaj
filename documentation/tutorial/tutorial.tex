...
Core definitions of a video type, and functionality for displaying videos.
\end{minipage}}.
...
Plugin to use {\textit xuggler} as a video source. Allows most video formats to be read into OpenIMAJ.
\end{minipage}}.
