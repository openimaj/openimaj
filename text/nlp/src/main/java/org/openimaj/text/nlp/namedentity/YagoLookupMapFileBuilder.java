...
private static final String DEFAULT_MAP_TEXTFILE = File.separator+".YagoLookup"+File.separator+"YagoCompanyAlias.txt";
...
private static Object QUIET="-quiet";
	...
	public static String getDefaultMapFilePath(){
		return System.getProperty("user.home")+DEFAULT_MAP_TEXTFILE;
	}
	
	public static void buildDefault() throws IOException{
		File f = validateLocalOutput(getDefaultMapFilePath(),true,false);
		f.createNewFile();
		new YagoLookupMapFactory(true).createListFileFromSparqlEndpoint(YagoQueryUtils.YAGO_SPARQL_ENDPOINT,getDefaultMapFilePath());
	}
