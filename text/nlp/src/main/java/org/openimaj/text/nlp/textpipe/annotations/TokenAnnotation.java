 ...
 * 
 */
public class TokenAnnotation<TOKENISER extends ReversableTokeniser<TOKENISER,TokenAnnotation<TOKENISER>>> extends TextPipeAnnotation implements ReversableToken<TOKENISER,TokenAnnotation<TOKENISER>> {
	String stringToken;
	String raw;
	public int start;
	public int stop;
	...
	@Override
	public Class getTokeniserClass(){
		return null;
	}
