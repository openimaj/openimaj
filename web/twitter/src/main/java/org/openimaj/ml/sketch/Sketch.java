 ...
 * 
 * "Sketching" data structures store a summary of a data set in situations where the whole 
 ...
 *
 */
public interface Sketch<T,V> {
	/**
	 * @param data update the sketch with this data
	 * @param value the value to update with
	 */
	public void update(T data, V value);
	
	/**
	 * @param data the data to query with
