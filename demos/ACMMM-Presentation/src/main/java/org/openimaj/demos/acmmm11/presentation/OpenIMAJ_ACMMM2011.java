...
public class OpenIMAJ_ACMMM2011 {
	public static void main(String[] args) throws MalformedURLException, IOException {
		...
		slides.add(new PictureSlide(OpenIMAJ_ACMMM2011.class.getResource("slide.004.png"))); // History of development
		slides.add(new PictureSlide(OpenIMAJ_ACMMM2011.class.getResource("slide.005.png"))); // Why another set of libraries?
		slides.add(new PictureSlide(OpenIMAJ_ACMMM2011.class.getResource("slide.006.png"))); // Designed to be EXTENSIBLE
		slides.add(new PictureSlide(OpenIMAJ_ACMMM2011.class.getResource("slide.007.png"))); // Alt SIFT: DoG/SIFT
		slides.add(new PictureSlide(OpenIMAJ_ACMMM2011.class.getResource("slide.008.png"))); // Alt SIFT: highlight dom ori
		slides.add(new PictureSlide(OpenIMAJ_ACMMM2011.class.getResource("slide.009.png"))); // Alt SIFT: replace with Null ori
		slides.add(new PictureSlide(OpenIMAJ_ACMMM2011.class.getResource("slide.010.png"))); // Alt SIFT: highlight SIFT feature
		slides.add(new PictureSlide(OpenIMAJ_ACMMM2011.class.getResource("slide.011.png"))); // Alt SIFT: replace with Irregular binning SIFT
		slides.add(new SIFTAltSIFTSlide()); // Normal vs ALT demo
		slides.add(new PictureSlide(OpenIMAJ_ACMMM2011.class.getResource("slide.012.png"))); // All in java, isnt it slow?!
